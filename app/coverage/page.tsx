    ...
    <div className="min-h-screen bg-background pt-20">
      ...
      <div className="container mx-auto px-6 py-12">
        <PageHeading
          ...
          subtitle="Identify sensor coverage gaps and contribute to water monitoring in underserved watersheds. Deploy nodes, earn x402 micropayments, and help protect critical water systems."
        />
      </div>
      ...
      {/* Propose sensor CTA */}
      <div className="container mx-auto px-6 py-8">
        <div className="max-w-4xl mx-auto border border-border/60 bg-card/70 rounded-lg p-12 text-center backdrop-blur-sm">
          <h3 className="text-2xl font-light tracking-[0.3em] text-foreground/90 mb-4 uppercase">Propose a Sensor Location</h3>
